# LexAd — 广告合规与舆情风险审查平台 v0.6.0

LexAd 面向市场部、法务部和管理员，在广告发布前完成法律合规与舆情风险双轴审查。市场人员提交文案或文件后，系统生成可追溯的审查结果；法务人员完成通过、退回或有条件通过的决定；管理员维护舆情案例和平台规则。

v0.6.0 更新了响应式界面与深浅主题，引入品牌库，并完善了本地数据库模式和一键启动流程。登录页继续与登录后的应用壳层严格分离；桌面端使用深色固定侧栏，紧凑窗口和手机端使用顶部导航与抽屉。
...
完整内容见 [v0.6.0 发布说明](docs/v0.6.0-release-notes.md)。
...
- [v0.6.0 发布说明](docs/v0.6.0-release-notes.md)
