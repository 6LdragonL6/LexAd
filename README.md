...
- 舆情安全分越高，表示当前自动审查识别的社会观感与传播风险越低；
- 舆情结果不计入法律合规分；
...
- 后端完整回归：128 项测试通过；
- 前端：9 项单元测试、TypeScript 检查与生产构建通过；
- 核心覆盖：真实审核进度、双正向评分、带风险通过确认、来源一致返回、数据库迁移，以及既有裁决、权限与版本追溯。
...
| 版本 | 日期 | 主要变化 |
| --- | --- | --- |
| v0.7.2 | 2026-07-15 | 真实阶段进度、法规/舆情双正向评分、带风险通过确认与来源一致返回 |
